package com.fatec.agenda.storage;
...
public class FotoStorageS3 implements FotoStorage{
    ...
    public String salvar(MultipartFile foto) {
        ...
        try {
            ...
            s3Client.putObject("agenda", nomeFoto, foto.getInputStream(), metadata);
    ...
    public String getUrl(String nomeFoto){
        return "http://localhost:9444/s3/agenda/" + nomeFoto + "?noAuth=true";
    }
